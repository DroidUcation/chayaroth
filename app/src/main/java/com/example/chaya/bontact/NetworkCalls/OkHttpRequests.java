...
public class OkHttpRequests implements Callback {
    ...
    private ServerCallResponse callback;

    public OkHttpRequests(String url, ServerCallResponse callback) {
        this(url, callback, null);
    }

    public OkHttpRequests(String url,ServerCallResponse callback, String postData) {
    ...
    public void sendRes(boolean isSuccsed, String response, ErrorType errorType) {
       if(callback!=null)
           callback.OnServerCallResponse(isSuccsed, response, errorType);
