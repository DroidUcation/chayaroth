...
public class Contract {
    public static class Conversation implements BaseColumns {
        ...
        public static final String TABLE_NAME = "TblConversation";
        ...
        public static final String COLUMN_ASSIGN = "assign";
    ...
    public static class InnerConversation implements BaseColumns {
        ...
        public static final String TABLE_NAME = "TblInnerConversation";
    ...
    public static class Agents implements BaseColumns {
        public static final String AUTHORITY = "com.example.chaya.bontact.Data.RepresentativeProvider";
        public static final String URL = "content://" + AUTHORITY;
        public static final Uri AGENTS_URI = Uri.parse(URL);
        public static final String TABLE_NAME = "TblAgents";
        public static final String COLUMN_ID_REP = "id_Representive";
        public static final String COLUMN_NAME = "name";
